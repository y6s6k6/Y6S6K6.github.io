...
!function (e, t) {
    ...
    function t(t) {
        ...
        try {
            n = function (e) {
                ...
                for (; !e.end();) {
                    let s = e.curr();
                    if ("(" == s) n.push(s), t = ""; else if (")" == s || "," == s) {
                        if (/^\-\-.+/.test(t) && (i.name ? (i.alternative || (i.alternative = []), i.alternative.push({name: t})) : i.name = t), ")" == s) {
    ...
    function n(e) {
        return {
            make_array: function (e) {
                ...
                let n = Array.from ? Array.from(t) : t.slice(), r = t.length;
                for (; r;) {
                    let t = ~~(e() * r--), i = n[r];
                    n[r] = n[t], n[t] = i;
                }
    ...
    function f(e, t) {
        let n, r = o.step();
        for (; !e.end() && "}" != (n = e.curr());) if (l.white_space(n)) e.next(); else {
            if (r.name.length) {
    ...
    function x(e, t, n) {
        let r, u = [], c = [], h = [], p = "";
        for (; !e.end();) {
            if (r = e.curr(), /[\('"`]/.test(r) && "\\" !== e.curr(-1)) h.length && "(" != r && r === i(h) ? h.pop() : h.push(r), p += r; else if ("@" != r || n) if (n && /[)]/.test(r) || !n && /[,)]/.test(r)) if (h.length) ")" == r && h.pop(), p += r; else {
                if (p.length && (c.length ? c.push(o.text(p)) : c.push(o.text((d = p).trim().length ? l.number(+d) ? +d : d.trim() : d)), p.startsWith("\xb1") && !n)) {
                    let e = p.substr(1), t = s(c);
                    i(t).value = "-" + e, u.push(b(t)), i(c).value = e;
                }
                if (u.push(b(c)), [c, p] = [[], ""], ")" == r) break;
            } else a[r] && !/[0-9]/.test(e.curr(-1)) && (r = a[r]), p += r; else c.length || (p = p.trimLeft()), p.length && (c.push(o.text(p)), p = ""), c.push(w(e));
    ...
    function w(e) {
        let t, n = o.func(), r = "@", i = !1;
        for (e.next(); !e.end();) {
            t = e.curr();
            let s = "." == t && "@" == e.curr(1), o = e.curr(1);
            if ("(" == t || s) {
        ...
        let {fname: s, extra: l} = function (e) {
            let t = "", n = "";
        ...
        return n.name = s, l.length && n.arguments.unshift([{type: "text", value: l}]), n.position = e.info().index, n;
    }

    function $(e) {
        let t, n = o.text(), r = 0, i = !0;
        const s = [], u = [];
        for (s[r] = []; !e.end();) if (t = e.curr(), i && l.white_space(t)) e.next(); else {
            if (i = !1, "\n" != t || l.white_space(e.curr(-1))) if ("," != t || u.length) {
                if (/[;}]/.test(t)) {
            ...
            } else n.value.length && (s[r].push(n), n = o.text()), s[++r] = [], i = !0; else n.value += " ";
            e.next();
        }
    ...
    function T(e, t) {
        ...
        for (; !e.end() && "}" != (n = e.curr());) {
            ...
            } else r.styles.push(T(e)); else Object.assign(r, E(e));
            e.next();
        }
        return r;
    }
    ...
    function P(t, n) {
        ...
        for (; !r.end();) {
            let e = r.curr();
            if (l.white_space(e)) r.next(); else {
                if ("/" == e && "*" == r.curr(1)) y(r); else if ("/" == e && "/" == r.curr(1)) y(r, {inline: !0}); else if (":" == e) {
                    ...
                    if ("<" == e) v(r); else if (!l.white_space(e)) {
                        let e = S(r, n);
                        e.property && i.push(e);
                    }
                } else {
    ...
    function C(e, t, n) {
        ...
        let l = [];
        for (; (n >= 0 && e <= t || n < 0 && e > t) && (l.push(e), e += n, !(r++ >= 1e3));) ;
    ...
    function X(e) {
        ...
        const i = 1 == t || 1 == n ? W : H, s = 1 == t && 1 == n ? W : F,
            o = {x: M(t || F, 1, i), y: M(n || t || F, 1, i), z: M(r || F, 1, s)};
        return Object.assign({}, o, {count: o.x * o.y * o.z});
    }
    ...
    let {last: Q} = n();
    const ee = {\u03c0: Math.PI, "\u220f": Math.PI};

    function te(e, t) {
        return re(ie(e), Object.assign(ee, t));
    }

    const ne = {"^": 4, "*": 3, "/": 3, "%": 3, "+": 2, "-": 2, "(": 1, ")": 1};
    ...
    function re(e, t, n = []) {
        ...
        for (; e.length;) {
            ...
            if ("variable" === l) {
                ...
                let e, n = o.map((e => re(e, t))), i = s.split(".");
                for (; e = i.pop();) {
                    if (!e) continue;
                    let r = t[e] || Math[e];
    ...
    function ie(e) {
        let t = function (e) {
            ...
            for (let e = 0; e < t.length; ++e) {
                let i = t[e];
                if (ne[i]) if ("-" == i && "e" == t[e - 1]) r += i; else if (n.length || r.length || !/[+-]/.test(i)) {
                    let {type: e, value: t} = Q(n) || {};
                    "operator" == e && !r.length && /[^()]/.test(i) && /[^()]/.test(t) ? r += i : (r.length && (n.push({
                        type: "number",
                        value: r
                    }), r = ""), n.push({type: "operator", value: i}));
                } else r += i; else /\S/.test(i) && ("," == i ? (n.push({
                    type: "number",
                    value: r
                }), r = "", n.push({type: "comma", value: i})) : r += i);
            }
        ...
        for (let e = 0; e < t.length; ++e) {
            ...
            if ("number" == i) if ("(" == o.value && /[^\d.]/.test(s)) {
                ...
                n.length && o.push(ie(n)), r.push({type: "function", name: s, value: o});
    ...
    const de = ae("build_range", (e => {
        let t = function (e) {
            ...
            for (let e = 1; e < t.length - 1; ++e) {
                let i = t[e];
                if ("-" != i || "-" != t[e - 1]) if ("-" != i) if ("-" != ue(r)) r.length && n.push(pe("char", r.pop())), r.push(i); else {
                    r.pop();
                    let e = r.pop();
    ...
    const {cos: ge, sin: ye, sqrt: ve, atan2: _e, pow: xe, PI: be} = Math, we = be / 180;

    function $e(e, t) {
        "function" == typeof arguments[0] && (t = e, e = {}), t || (t = e => [ge(e), ye(e)]);
        let n, r, i = e.split || 120, s = e.scale || 1, o = we * (e.start || 0), l = e.deg ? e.deg * we : be / (i / 2),
            a = [], u = ([e, t], n) => {
        ...
        if (void 0 !== e.frame) {
            ...
            a <= 0 && (a = .002);
            for (let e = 0; e < i; ++e) {
                let n = o + l * e, [i, c] = t(n, e), h = _e(c, i), p = [i - a * ge(h), c - a * ye(h)];
                e || (r = p), u(p, s);
            }
            u(r, s), u(n, s);
        }
    ...
    const ze = {
        circle: () => "circle(49%)",
        triangle: () => $e({split: 3, start: -90}, (e => [1.1 * ge(e), 1.1 * ye(e) + .2])),
        rhombus: () => $e({split: 4}),
        pentagon: () => $e({split: 5, start: 54}),
        hexgon: () => $e({split: 6, start: 30}),
        hexagon: () => $e({split: 6, start: 30}),
        heptagon: () => $e({split: 7, start: -90}),
        octagon: () => $e({split: 8, start: 22.5}),
        star: () => $e({split: 5, start: 54, deg: 144}),
        diamond: () => "polygon(50% 5%, 80% 50%, 50% 95%, 20% 50%)",
        cross: () => "polygon(\n 5% 35%, 35% 35%, 35% 5%, 65% 5%,\n 65% 35%, 95% 35%, 95% 65%, 65% 65%,\n 65% 95%, 35% 95%, 35% 65%, 5% 65%\n )",
        clover: (e = 3) => (4 == (e = M(e, 3, 5)) && (e = 2), $e({split: 240}, (t => {
            let n = ge(e * t) * ge(t), r = ge(e * t) * ye(t);
            return 3 == e && (n -= .2), 2 == e && (n /= 1.1, r /= 1.1), [n, r];
        }))),
        hypocycloid(e = 3) {
            let t = 1 - (e = M(e, 3, 6));
            return $e({scale: 1 / e}, (n => {
                let r = t * ge(n) + ge(t * (n - be)), i = t * ye(n) + ye(t * (n - be));
                return 3 == e && (r = 1.1 * r - .6, i *= 1.1), [r, i];
            }));
        },
        astroid: () => ze.hypocycloid(4),
        infinity: () => $e((e => {
            let t = .7 * ve(2) * ge(e), n = xe(ye(e), 2) + 1;
            return [t / n, t * ye(e) / n];
        })),
        ...
        bud: (e = 3) => (e = M(e, 3, 10), $e({split: 240}, (t => [(1 + .2 * ge(e * t)) * ge(t) * .8, (1 + .2 * ge(e * t)) * ye(t) * .8]))),
        alien(...e) {
    ...
    function Te(e) {
        let t = Object.assign({}, e, {split: M(parseInt(e.split) || 0, 3, 3600), start: 0});
        e.degree && (e.rotate = e.degree);
        let n = Se(e.x) ? "cos(t)" : e.x, r = Se(e.y) ? "sin(t)" : e.y, i = Se(e.r) ? "" : e.r;
        return $e(t, ((t, s) => {
            let o = Object.assign({}, e, {t, \u03b8: t, seq: (...e) => e.length ? e[s % e.length] : ""}), l = te(n, o),
                a = te(r, o);
            if (i) {
                let e = te(i, o);
    ...
    function Ce(t) {
        const {shuffle: r} = n(t), {pick: i, rand: s, nrand: o, unique_id: l} = Z(t), a = {
            index: ({count: e}) => t => e,
            row: ({y: e}) => t => e,
            col: ({x: e}) => t => e,
            depth: ({z: e}) => t => e,
            size: ({grid: e}) => t => e.count,
            "size-row": ({grid: e}) => t => e.y,
            "size-col": ({grid: e}) => t => e.x,
            "size-depth": ({grid: e}) => t => e.z,
            id: ({x: e, y: t, z: n}) => r => U(e, t, n),
            n: ({extra: e}) => t => e ? e[0] : "@n",
            nx: ({extra: e}) => t => e ? e[1] : "@nx",
            ny: ({extra: e}) => t => e ? e[2] : "@ny",
            N: ({extra: e}) => t => e ? e[3] : "@N",
            repeat: u(""),
            multiple: u(","),
            "multiple-with-space": u(" "),
            pick: ({context: e}) => he(((...t) => c(e, "last_pick", i(t)))),
            "pick-n"({context: e, extra: t, position: n}) {
                let r = "pn-counter" + n;
                return he(((...n) => {
                    e[r] || (e[r] = 0), e[r] += 1;
                    let i = n.length, [s] = t || [], o = n[((void 0 === s ? e[r] : s) - 1) % i];
                    return c(e, "last_pick", o);
                }));
            },
            "pick-d"({context: e, extra: t, position: n}) {
                let i = "pd-counter" + n, s = "pd-values" + n;
                return he(((...n) => {
                    e[i] || (e[i] = 0), e[i] += 1, e[s] || (e[s] = r(n));
                    let o = n.length, [l] = t || [], a = ((void 0 === l ? e[i] : l) - 1) % o, u = e[s][a];
                    return c(e, "last_pick", u);
                }));
            },
            "last-pick": ({context: e}) => (t = 1) => {
                let n = e.last_pick;
                return n ? n.last(t) : "";
            },
            rand: ({context: e}) => (...t) => {
            ...
            "nrand-int": ({context: e}) => (...t) => {
                let n = (t.every(L) ? K : J)(((...e) => Math.round(o(...e)))).apply(null, t);
                return c(e, "last_rand", n);
            },
            "last-rand": ({context: e}) => (t = 1) => {
                let n = e.last_rand;
                return n ? n.last(t) : "";
            },
            stripe: () => (...e) => {
                let t, n = e.map(D), r = n.length, i = 0, s = [];
                if (!r) return "";
                n.forEach((e => {
                    let [t, n] = Re(e);
        ...
        function u(e) {
            return O(((t, n) => {
                ...
                return function (e, t) {
                    ...
                    let i = n * r, s = [], o = 1;
                    for (let e = 1; e <= r; ++e) for (let r = 1; r <= n; ++r) s.push(t(o++, r, e, i));
                    return s;
    ...
    const Be = {
        ...
        "business-card": [54, 90],
        poster: [390, 540]
    }, Fe = {portrait: "p", pt: "p", p: "p", landscape: "l", ls: "l", l: "l"};
    var He = {
        "@size"(e, {is_special_selector: t}) {
            ...
            return n => {
                let [r, i = "50%"] = Re(n);
                r = e[r] || r, i = t[i] || i;
                const s = "var(--internal-cell-width, 25%)", o = "var(--internal-cell-height, 25%)";
            ...
            return r = r.join(" / "), {grid: X(n), size: r ? this["@size"](r, t) : ""};
    ...
    function We(e, t, n) {
        ...
        for (let e = 0; e <= n; ++e) if (te(r(e)) == t) return !0;
    }

    const Xe = {even: e => !(e % 2), odd: e => !!(e % 2)};
    ...
    let {join: Ye, make_array: Ze, remove_empty_values: Je} = n();
    ...
    class tt {
        constructor(e, t) {
            this.tokens = e, this.rules = {}, this.props = {}, this.keyframes = {}, this.grid = null, this.is_grid_defined = !1, this.coords = [], this.doodles = {}, this.shaders = {}, this.paths = {}, this.reset(), this.Func = Ce(t), this.Selector = function (e) {
                return {
                    ...
                    nth: ({count: e, grid: t}) => (...n) => n.some((n => qe(n) ? Xe[n](e) : We(n, e, t.count))),
                    row: ({y: e, grid: t}) => (...n) => n.some((n => qe(n) ? Xe[n](e) : We(n, e, t.y))),
                    col: ({x: e, grid: t}) => (...n) => n.some((n => qe(n) ? Xe[n](e) : We(n, e, t.x))),
                    even: ({count: e, grid: t, y: n}) => r => {
        ...
        reset() {
            this.styles = {host: "", container: "", cells: "", keyframes: ""}, this.coords = [], this.doodles = {};
        ...
        apply_func(e, t, n) {
            ...
            return n.forEach((e => {
                ...
                if (!e.cluster && n) i.push(...Re(e.value, !0)); else if ("function" == typeof e) i.push(e); else if (!I(e.value)) {
                    let t = D(e.value);
                    i.push(t);
                }
            })), i = Je(i), r(...Ze(i));
        ...
        compose_argument(e, t, n = []) {
            ...
            return {cluster: e.cluster, value: r.length >= 2 ? {value: r.join("")} : r[0]};
        }
        ...
        compose_shaders(e, {x: t, y: n, z: r}) {
            ...
            return this.shaders[i] = {shader: e, cell: U(t, n, r)}, "${" + i + "}";
        }

        compose_path(e) {
            let t = this.unique_id("path");
            return this.paths[t] = {id: t, commands: e}, "${" + t + "}";
        }
            ...
            return Array.isArray(e) ? e.reduce(((e, n) => {
                switch (n.type) {
                    case "text":
                        ...
                        break;
                    case "func": {
                        let r = n.name.substr(1), i = this.pick_func(r);
                        if ("function" == typeof i) if ("t" === r && (this.uniforms.time = !0), this.is_composable(r)) {
        ...
        compose_rule(e, t, n) {
            let r = Object.assign({}, t), i = e.property, s = e.value.reduce(((e, t) => {
            ...
            if (l = Ne(i, l), "clip-path" === i && (l += ";overflow:hidden;"), "width" !== i && "height" !== i || et(n) || (l += `--internal-cell-${i}:${o};`), "background" === i && o.includes("shader") && (l += "background-size:100% 100%;"), /^\-\-/.test(i) && (this.custom_properties[i] = o), He[i]) {
                let t = He[i](o, {is_special_selector: et(n)});
                switch (i) {
                    case "@grid":
                        Ke(n) ? l = t.size || "" : (l = "", this.is_grid_defined || (t = He[i](o, {is_special_selector: !0}), this.add_rule(":host", t.size || ""))), this.grid = r.grid, this.is_grid_defined = !0;
                        break;
                    case "@place-cell":
                        Ke(n) || (l = t);
                        break;
        ...
        output() {
            Object.keys(this.rules).forEach(((e, t) => {
                if (Qe(e)) this.styles.container += `\n .container{${Ye(this.rules[e])}}`; else {
                    let t = Ke(e) ? "host" : "cells", n = Ye(this.rules[e]).trim(),
                        r = "host" === t ? `${e}, .host` : e;
                    this.styles[t] += `${r}{${n}}`;
                }
            }));
            ...
            this.uniforms.time && (this.styles.container += `\n:host, .host{animation:${Me.animation};}`, this.styles.keyframes += `\n @keyframes ${Me["animation-name"]}{from{--${Me.name}:0} to{--${Me.name}:${Me["animation-duration"]}}}`), this.coords.forEach(((t, n) => {
                e.forEach((e => {
                    ...
                    `, i ? "function" == typeof s ? s():s:""} @keyframes ${r}{${this.keyframes[e](t)}}`;
                }));
            }));
            let t = [];
    ...
    function nt(e, t, n) {
        let r = new tt(e, n), i = {};
        r.pre_compose({x: 1, y: 1, z: 1, count: 1, context: {}, grid: {x: 1, y: 1, z: 1, count: 1}});
        let {grid: s} = r.output();
        if (s && (t = s), r.reset(), 1 == t.z) for (let e = 1, n = 0; e <= t.y; ++e) for (let s = 1; s <= t.x; ++s) r.compose({
            x: s,
            y: e,
            z: 1,
            count: ++n,
            grid: t,
            context: i
        }); else for (let e = 1, n = 0; e <= t.z; ++e) r.compose({x: 1, y: 1, z: e, count: ++n, grid: t, context: i});
        return r.output();
    }

    var rt = window, it = Math, st = [], ot = 256, lt = it.pow(ot, 6), at = it.pow(2, 52), ut = 2 * at, ct = 255;

    function ht(e, t, n) {
        var r = [], i = mt(ft((t = 1 == t ? {entropy: !0} : t || {}).entropy ? [e, gt(st)] : null == e ? function () {
            try {
                var e;
                return e = new Uint8Array(ot), (rt.crypto || rt.msCrypto).getRandomValues(e), gt(e);
            } catch (e) {
                var t = rt.navigator, n = t && t.plugins;
                return [+new Date, rt, n, rt.screen, gt(st)];
            }
        }() : e, 3), r), s = new pt(r), o = function () {
    ...
    function _t(e, t, n) {
        let r = document.createElement("canvas"), i = window.devicePixelRatio || 1;
        ...
        let l = function (e, t, n) {
                let r = yt(e, e.VERTEX_SHADER, t), i = yt(e, e.FRAGMENT_SHADER, n), s = e.createProgram();
            ...
            a = s.getAttribLocation(l, "position"), u = s.createBuffer();
    ...
    class xt extends HTMLElement {
        constructor() {
            super(), this.doodle = this.attachShadow({mode: "open"}), this.extra = {
        ...
        update(e) {
            ...
            let {x: n, y: r, z: i} = this.grid_size;
        ...
        doodle_to_image(e, t, n) {
            ...
            let r = P(e, this.extra), i = X({}), s = nt(r, i, this.random), o = s.grid ? s.grid : i;
            const {keyframes: l, host: a, container: u, cells: c} = s.styles;
            let h = this.build_svg_paths(s.paths), p = this.replace(s), d = kt(o);
        ...
        shader_to_image({shader: e, cell: t}, n) {
            let r = function (e) {
                    let t = "", n = "", r = "", i = [], s = {textures: []}, o = "", l = [], a = 0;
                    for (; void 0 !== (t = e[a++]);) if ('"' != t && "'" != t || (G(i) == t ? i.pop() : i.push(t)), "{" != t || q(G(i))) if ("}" != t || q(G(i))) /\s/.test(t) && o.length ? (l.push(o), o = "", ("#define" == l[l.length - 3] || "#ifdef" == l[l.length - 2] || "#else" == l[l.length - 1] || "#endif" == l[l.length - 1]) && (n += "\n")) : o += t, n += t; else if (i.pop(), i.length) n += t; else {
                        let e = r.trim(), t = n.trim().replace(/^\(+|\)+$/g, "");
                        e.length && (e.startsWith("texture") ? s.textures.push({name: e, value: t}) : s[e] = t), r = n = "";
                    } else i.length ? n += t : (r = n, n = ""), i.push(t);
                    return void 0 === s.fragment ? {fragment: e, textures: []} : s;
                }(e), i = this.doodle.getElementById(t), {width: s, height: o} = i.getBoundingClientRect(),
                l = window.devicePixelRatio || 1;
            if (r.textures.length) {
                let e = r.textures.map((e => new Promise((t => {
                    this.doodle_to_image(e.value, {width: s, height: o}, (n => {
                        let r = new Image;
                        r.width = s * l, r.height = o * l, r.onload = () => t({name: e.name, value: r}), r.src = n;
                    }));
                }))));
        ...
        load(e) {
            ...
            }(this.innerHTML), this.extra), r = this.generate(n);
            this.grid_size = r.grid ? r.grid : this.get_grid(), this.build_grid(r, this.grid_size);
        }

        replace({doodles: e, shaders: t, paths: n}) {
            let r = Object.keys(e), i = Object.keys(t), s = Object.keys(n);
            return n => {
                ...
                return Promise.all(o).then((e => (n.replaceAll ? e.forEach((({id: e, value: t}) => {
        ...
        build_grid(e, t) {
            ...
            let u = wt(t) + o + l, c = i ? "" : a, h = this.build_svg_paths(e.paths);
            const {uniforms: p} = e;
        ...
        register_uniform_time() {
            if (!this.is_uniform_time_registered) {
                try {
                    CSS.registerProperty({name: "--" + Me.name, syntax: "<number>", initialValue: 0, inherits: !0});
                } catch (e) {
                }
        ...
        export({scale: e, name: t, download: n, detail: r} = {}) {
            return new Promise(((i, s) => {
                let o = function (e) {
                    ...
                    }(this), l = this.doodle.innerHTML, {width: a, height: u} = this.getBoundingClientRect(),
    ...
    function kt({x: e, y: t, z: n}) {
        let r = document.createElement("grid"), i = document.createDocumentFragment();
        if (1 == n) for (let n = 1; n <= t; ++n) for (let t = 1; t <= e; ++t) i.appendChild($t(t, n, 1)); else {
            let e = null;
            for (let t = 1; t <= n; ++t) {
                let n = $t(1, 1, t);
    ...
    return customElements.get("css-doodle") || customElements.define("css-doodle", xt), function (e, ...t) {
